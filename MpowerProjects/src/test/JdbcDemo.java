...
public class JdbcDemo {
	...
	public static void main(String[] args) throws Exception {
		addUser("govardhan", 9886, "Hyd");
		updateUser("buddy",99667792);
		selectUser();
	 ...
	 * @throws SQLException
	 */
	public static void addUser(String name, Integer phoneNumber, String place) throws SQLException{
	...
	public static void updateUser(String name,Integer phoneNumber) throws SQLException{
